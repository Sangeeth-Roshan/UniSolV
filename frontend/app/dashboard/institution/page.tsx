  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="page-subtitle">Tickets assigned to your institution — accept, work on, and submit proposals.</p>
      </div>
                ...
                <div className="mt-2.5 flex items-center gap-2.5 flex-wrap">
                  ...
                  {ticket.contact_phone && (
                    <a
                      ...
                      className="text-xs text-indigo-300 hover:text-indigo-200 flex items-center gap-1.5 bg-indigo-500/10 border border-indigo-500/20 px-2.5 py-0.5 rounded-md transition-colors"
                      title="Citizen contact number for follow-up"
                    >
                      ...
                      <span>Citizen Contact: <span className="text-white font-mono font-medium">{ticket.contact_phone}</span></span>
                    </a>
                  )}
                </div>
              </div>
